...
public class Hacker : MonoBehaviour
{
    ...
    string[] level1Passwords = { "llab", "rac", "der", "kcaj", "kcik", "ysae" };
    string[] level2Passwords = { "rebbur", "gnorts", "egnaro", "wolley", "cinagro" };
    string[] level3Passwords = { "msilaicos", "dossier", "tnemnorivne", "noitartsinimda"};
    ...
    void ShowMainMenu()
    {
        ...
        //  We show the menu
        Terminal.WriteLine("Let's start you trainning as a hacker");
        Terminal.WriteLine("Which level you want to train?");
        Terminal.WriteLine("");
        Terminal.WriteLine("Press 1 Easy");
        Terminal.WriteLine("Press 2 Medium");
        Terminal.WriteLine("Press 3 Hard");
        Terminal.WriteLine("");
    ...
    private void ShowLevelReward()
    {
        ...
        {
            case 1:
                Terminal.WriteLine("You are just a beginner! But keep on working");
                break;
            case 2:
                Terminal.WriteLine("You might be worthy but no yet. Get back to work");
                break;
            case 3:
                Terminal.WriteLine("Great job! You're a master");
                break;
            default:
    ...
    void RunMainMenu(string input)
    {
        ...
        else if (input == "Bjergsen")
        {
            Terminal.WriteLine("Senpai, Mr Bejerg king go on a win NALCS");
        }
    ...
    private void AskForPassword()
    {
        ...
        //  its characters.
        Terminal.WriteLine("Enter your password, but backwards.");
